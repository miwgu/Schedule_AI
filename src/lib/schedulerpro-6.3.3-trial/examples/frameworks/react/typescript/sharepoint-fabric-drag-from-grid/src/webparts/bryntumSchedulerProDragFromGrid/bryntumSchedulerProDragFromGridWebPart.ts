...
import * as strings from 'BryntumSchedulerProWebPartStrings';
...
export interface IBryntumSchedulerProWebPartProps {
...
export default class BryntumSchedulerProWebPart extends BaseClientSideWebPart <IBryntumSchedulerProWebPartProps> {
