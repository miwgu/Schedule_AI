            ...
            eventDrag   : {
                tooltipTemplate : ({
                    ...
                    <div class="b-tooltip-section">
                        ...
                        <ul class="skills">
                            ${eventRecord.requiredSkillRecords.map(skillRecord => {
                        var _newResource$skills, _newResource$skills$i;
                        return `<li><i class="b-icon b-fa-${(_newResource$skills = newResource.skills) !== null && _newResource$skills !== undefined && (_newResource$skills$i = _newResource$skills.includes) !== null && _newResource$skills$i !== undefined && _newResource$skills$i.call(_newResource$skills, skillRecord.id) ? 'check' : 'xmark'}"></i>${StringHelper.encodeHtml(skillRecord.name)}</li>`;
                    }).join('')}
                        </ul>
                    </div>
                    <div class="b-tooltip-section">
...
class Task extends EventModel {
    ...
    get requiredSkillRecords() {
        ...
        return ((_this$skills = this.skills) === null || _this$skills === undefined ? undefined : _this$skills.map(id => skillStore.getById(id))) || [];
    }
    get requiredSkillNames() {
        var _this$skills2;
        const skillStore = this.firstStore.crudManager.getCrudStore('skills');
        return ((_this$skills2 = this.skills) === null || _this$skills2 === undefined ? undefined : _this$skills2.map(id => skillStore.getById(id).name)) || [];
    }
}
...
class Technician extends ResourceModel {
    ...
    canPerformTask(taskRecord, startDate) {
        const {
            ...
            skillsMatch = !requiredSkills || requiredSkills.every(skillId => {
                var _this$skills3;
                return (_this$skills3 = this.skills) === null || _this$skills3 === undefined ? undefined : _this$skills3.includes(skillId);
            }),
    ...
    get skillNames() {
        ...
        return ((_this$skills4 = this.skills) === null || _this$skills4 === undefined ? undefined : _this$skills4.map(id => skillStore.getById(id).name)) || '';
    }
