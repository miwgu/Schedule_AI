...
<div class="flight">
    <div class="taxiing">${((_eventRecord$preamble = eventRecord.preamble) === null || _eventRecord$preamble === undefined ? undefined : _eventRecord$preamble.magnitude) || ''}<i class="b-fa b-fa-plane-departure"></i></div>
    ...
    <div class="taxiing">${((_eventRecord$postambl = eventRecord.postamble) === null || _eventRecord$postambl === undefined ? undefined : _eventRecord$postambl.magnitude) || ''}<i class="b-fa b-fa-plane-arrival"></i></div>
</div>`;
    },
...
// Show info about linked flight when available
    flight2 ? flightTemplate(flight2) + timingRowTemplate(flight2) : '') + (flight1.warning ? `<div class="warning"><i class="b-fa b-fa-warning"></i> ${flight1.warning}</div>` : '');
