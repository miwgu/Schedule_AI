...
const data = {
    resources : [{
        ...
        id               : 11,
        name             : 'Helicopter 1',
        iconCls          : 'b-fa b-fa-helicopter',
        image            : false,
        vehicleCondition : 1
    }, {
        id               : 12,
        name             : 'Rocket 1',
        iconCls          : 'b-fa b-fa-rocket',
        image            : false,
        vehicleCondition : 0
    }, {
        id               : 13,
...
class VehicleConditionCombo extends Combo {
    ...
    syncInputFieldValue(...args) {
        ...
        this.icon.className = `b-fa b-fa-car ${condition === null || condition === undefined ? undefined : condition.toLowerCase()}`;
