...
```shell
npm install @bryntum/schedulerpro-angular-view@6.3.3
```
...
```shell
npm install @bryntum/schedulerpro-angular@npm@bryntum/schedulerpro-angular-view@6.3.3
```
...
You will also need to import CSS file for Bryntum Scheduler Pro. We recommend doing it in `src/styles.scss`:
