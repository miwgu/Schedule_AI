...
<a href="#SchedulerPro/guides/integration/ionic/multiple-products.md#package-dependencies">required dependencies</a>.
...
```shell
npm install @bryntum/schedulerpro-thin@npm:@bryntum/schedulerpro-thin-trial@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/schedulerpro-thin": "npm:@bryntum/schedulerpro-thin-trial@6.3.3",
}
```
