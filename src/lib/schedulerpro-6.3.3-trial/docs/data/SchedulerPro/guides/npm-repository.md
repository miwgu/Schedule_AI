...
npm install @bryntum/schedulerpro-angular@6.3.3
```
...
```shell
yarn add @bryntum/schedulerpro@npm:@bryntum/schedulerpro-trial@6.3.3
yarn add @bryntum/schedulerpro-angular@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/schedulerpro": "npm:@bryntum/schedulerpro-trial@6.3.3",
  "@bryntum/schedulerpro-angular": "6.3.3"
}
```
...
The benefit of using npm package aliasing for trial packages above is that we create an alias for the `schedulerpro-trial` 
package using the name of the licensed `schedulerpro` package. This means there is no need to change your application code 
...
```shell
yarn add @bryntum/schedulerpro@6.3.3
yarn add @bryntum/schedulerpro-angular@6.3.3
```
...
[Access tokens](#SchedulerPro/guides/npm-repository.md#access-tokens),
[Access tokens CI/CD](#SchedulerPro/guides/npm-repository.md#access-tokens-for-cicd) and
[Artifactory integration](#SchedulerPro/guides/npm-repository.md#artifactory-integration) guides below.
...
<a href="#SchedulerPro/guides/npm-repository.md#repository-access">Repository access</a> instructions.
...
You may use [Access tokens](#SchedulerPro/guides/npm-repository.md#access-tokens) stored in `.npmrc` in Continuous
...
```json
"dependencies": {
  "@bryntum/schedulerpro-lib-trial": "file:./lib/bryntum-schedulerpro-lib-trial-6.3.3.tgz"  
  "@bryntum/schedulerpro": "file:./lib/bryntum-schedulerpro-trial-6.3.3.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/schedulerpro-lib": "file:./lib/bryntum-schedulerpro-lib-6.3.3.tgz"  
  "@bryntum/schedulerpro": "file:./lib/bryntum-schedulerpro-6.3.3.tgz"
}
```
</div>
</div>
...
```text
npm error 403 403 Forbidden - GET https://npm.bryntum.com/@bryntum/schedulerpro/-/schedulerpro-6.3.3.tgz -
npm error 403
npm error 403 --------------------------------------------------------
npm error 403                   BRYNTUM NPM REGISTRY
npm error 403 --------------------------------------------------------
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/schedulerpro@6.3.3’ is not in the npm registry.
```
...
➤ YN0035: │ @bryntum/schedulerpro@npm:6.3.3: Package not found
...
[Configure npm](#SchedulerPro/guides/npm-repository.md#configure-npm) guide and reinstall the package.
