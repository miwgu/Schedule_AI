...
<img src="SchedulerPro/getting-started-vue.png" class="b-screenshot" alt="Getting Started on Bryntum Scheduler Pro with Vue Result">
...
## Install Bryntum SchedulerPro packages
...
```shell
npm install @bryntum/schedulerpro@npm:@bryntum/schedulerpro-trial@6.3.3 @bryntum/schedulerpro-vue-3@6.3.3
```
...
```shell
npm install @bryntum/schedulerpro@6.3.3 @bryntum/schedulerpro-vue-3@6.3.3
```
</div>
</div>
...
<template>
  <bryntum-scheduler-pro v-bind="schedulerProConfig" />
</template>
