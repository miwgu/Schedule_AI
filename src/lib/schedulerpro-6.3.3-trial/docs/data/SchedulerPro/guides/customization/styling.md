...
To create your own theme, get the [distribution bundle](#SchedulerPro/guides/download.md) and follow these steps:
...
@import "@bryntum/schedulerpro/source/resources/sass/themes/classic.scss";
```
...
Please see 
<a href="../examples-scheduler/custom-theme/" target="_blank">Theme example</a> 
...
```plaintext
CSS version 5.6.1 doesn't match bundle version 6.3.3!
...
`6.3.3` of SchedulerPro, you need to have the CSS files of version `6.3.3`.
...
(`schedulerpro.stockholm.css?v=6.3.3`) or use timestamps (`schedulerpro.stockholm.css?1704085200`).
