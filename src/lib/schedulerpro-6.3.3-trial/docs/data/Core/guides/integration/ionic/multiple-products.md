...
<a href="#Core/guides/integration/ionic/multiple-products.md#package-dependencies">required dependencies</a>.
...
```shell
npm install @bryntum/core-thin@npm:@bryntum/core-thin-trial@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/core-thin": "npm:@bryntum/core-thin-trial@6.3.3",
}
```
