...
```shell
npm install @bryntum/core@npm:@bryntum/core-trial@6.3.3
npm install @bryntum/core-angular@6.3.3
```
...
```shell
yarn add @bryntum/core@npm:@bryntum/core-trial@6.3.3
yarn add @bryntum/core-angular@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/core": "npm:@bryntum/core-trial@6.3.3",
  "@bryntum/core-angular": "6.3.3"
}
```
...
```shell
npm install @bryntum/core@6.3.3
npm install @bryntum/core-angular@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/core-lib-trial": "file:./lib/bryntum-core-lib-trial-6.3.3.tgz"  
  "@bryntum/core": "file:./lib/bryntum-core-trial-6.3.3.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/core-lib": "file:./lib/bryntum-core-lib-6.3.3.tgz"  
  "@bryntum/core": "file:./lib/bryntum-core-6.3.3.tgz"
}
```
</div>
</div>
...
```text
npm error 403 403 Forbidden - GET https://npm.bryntum.com/@bryntum/core/-/core-6.3.3.tgz -
npm error 403
npm error 403 --------------------------------------------------------
npm error 403                   BRYNTUM NPM REGISTRY
npm error 403 --------------------------------------------------------
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/core@6.3.3’ is not in the npm registry.
```
...
➤ YN0035: │ @bryntum/core@npm:6.3.3: Package not found
