...
CSSHelper.insertRule('.foodmenu-combo .b-chip i { margin-inline-end:0.4em }');
CSSHelper.insertRule('.b-list-item-group-header { font-size:1.1em; }');
CSSHelper.insertRule('.b-foodmenu-item { display:flex; flex-direction:column; align-items:flex-start; margin-inline-start:0.3em}');
...
new Combo({
    ...
    picker       : {
        groupHeaderTpl : (record, groupName) => `
           <i class="b-fa b-fa-${groupName === 'Food' ? 'pizza-slice' : groupName === 'Drinks' ? 'wine-glass' : 'utensils'}" style="margin-inline-end:0.8em;"></i>${groupName}
        `
    },
    chipView : {
