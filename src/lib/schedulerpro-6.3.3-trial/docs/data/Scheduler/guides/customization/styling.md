...
`6.3.3` of Scheduler, you need to have the CSS files of version `6.3.3`.
...
(`scheduler.stockholm.css?v=6.3.3`) or use timestamps (`scheduler.stockholm.css?1704085200`).
