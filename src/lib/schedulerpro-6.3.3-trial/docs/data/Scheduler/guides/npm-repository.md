...
npm install @bryntum/scheduler-angular@6.3.3
```
...
```shell
yarn add @bryntum/scheduler@npm:@bryntum/scheduler-trial@6.3.3
yarn add @bryntum/scheduler-angular@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/scheduler": "npm:@bryntum/scheduler-trial@6.3.3",
  "@bryntum/scheduler-angular": "6.3.3"
}
```
...
```shell
npm install @bryntum/scheduler@6.3.3
npm install @bryntum/scheduler-angular@6.3.3
```
...
```shell
yarn add @bryntum/scheduler@6.3.3
yarn add @bryntum/scheduler-angular@6.3.3
```
...
```json
"dependencies": {
  "@bryntum/scheduler-lib-trial": "file:./lib/bryntum-scheduler-lib-trial-6.3.3.tgz"  
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-trial-6.3.3.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/scheduler-lib": "file:./lib/bryntum-scheduler-lib-6.3.3.tgz"  
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-6.3.3.tgz"
}
```
</div>
</div>
...
```text
npm error 403 403 Forbidden - GET https://npm.bryntum.com/@bryntum/scheduler/-/scheduler-6.3.3.tgz -
npm error 403
npm error 403 --------------------------------------------------------
npm error 403                   BRYNTUM NPM REGISTRY
npm error 403 --------------------------------------------------------
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/scheduler@6.3.3’ is not in the npm registry.
```
...
➤ YN0035: │ @bryntum/scheduler@npm:6.3.3: Package not found
