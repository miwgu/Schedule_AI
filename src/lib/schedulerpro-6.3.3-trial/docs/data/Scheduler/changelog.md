...
* It is now possible to exclude records from timezone conversion. Set the `timeZone` field to `false` on each record
  that should not be affected by the timeZone config (Fixes [#11610](https://github.com/bryntum/support/issues/11610))
...
<p class="last-modified">Last modified on 2025-10-06 8:18:52</p>