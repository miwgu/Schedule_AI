...
const scheduler = new Scheduler({
    ...
    onTimelineContextChange({
        ...
        (_document$querySelect = document.querySelector(`.b-sch-header-timeaxis-cell.highlight`)) === null || _document$querySelect === undefined || _document$querySelect.classList.remove('highlight');
        if (context) {
            ...
            (_document$querySelect2 = document.querySelector(`.b-sch-header-timeaxis-cell[data-tick-index="${tick}"]`)) === null || _document$querySelect2 === undefined || _document$querySelect2.classList.add('highlight');
        }
    }
});