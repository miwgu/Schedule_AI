...
class TinyMceField extends RichTextField.mixin(Delayable) {
    ...
    destroyEditor() {
        ...
        (_this$editor2 = this.editor) === null || _this$editor2 === undefined || _this$editor2.destroy(); // Destroy the existing instance
        this.editor = null;
    }
    ...
    internalOnPaint() {
        ...
        globalThis.tinymce.init({
            ...
            height            : me.height,
            target            : me.input,
            skin              : (_DomHelper$themeInfo = DomHelper.themeInfo) !== null && _DomHelper$themeInfo !== undefined && (_DomHelper$themeInfo = _DomHelper$themeInfo.name) !== null && _DomHelper$themeInfo !== undefined && _DomHelper$themeInfo.toLowerCase().endsWith('-dark') ? 'oxide-dark' : 'oxide',
            ui_mode           : 'split',
