...
import { LocaleHelper, Localizable, Base, GlobalEvents, AjaxHelper, AsyncHelper, BrowserHelper, DateHelper, DomHelper, StringHelper, DataGenerator, Fullscreen, Rectangle, VersionHelper, Events, Button, DemoCodeEditor, Toast, Tooltip, Widget, HintFlow } from '../../build/schedulerpro.wc.module.js';
/* global RC */
// Load product config
    ...
    insertHeader() {
        ...
        header.innerHTML = `
            ...
            <div id="title-container" class="title-container">
                <a id="title" class="title" href="${isDemoBrowser ? '#' : `../../examples/${isUmd ? 'index.umd.html' : ''}${this.rtl ? '?rtl' : ''}#example-examples-scheduler-${exampleId}`}">
                    <h1>${exampleName}</h1>
                </a>
            </div>
