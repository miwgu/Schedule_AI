            ...
            columns : [
                {
                    ...
                    headerRenderer() {
                        ...
                        <div class="b-column-header-row">
                            <i class="b-fa ${groupIcons[title?.toLowerCase()]}"></i>${title}
                        </div>`).join('');
                    },
                    filterable : {
                        filterField : {
                ...
                group     : {
                    renderer({
                        ...
                        if (rowElement.closest('[data-region="locked"]')) {
                            return `<i class="b-fa ${groupIcons[groupRowFor?.toLowerCase()]}"></i><span class="b-group-header-row-text">${groupRowFor}</span>`;
                        }
                    }
                }
            },
