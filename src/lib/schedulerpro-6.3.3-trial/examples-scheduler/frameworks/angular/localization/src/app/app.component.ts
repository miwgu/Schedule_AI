...
import { LocaleManager, Scheduler } from '@bryntum/schedulerpro';
import './app.locales.js';
...
export class AppComponent implements OnInit, AfterViewInit {
     ...
     */
    ngOnInit(): void {
        this.i18NextService.events.initialized.subscribe((e: any) => {
            if (e) {
    ...
    changeLanguage(lang: string): void {
        ...
        if (lang !== me.i18NextService.language) {
            me.i18NextService.changeLanguage(lang).then(() => {
