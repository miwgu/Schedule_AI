...
const scheduler = new Scheduler({
    ...
    columns : [{
        ...
        renderer({
            ...
            if (record.isParent) {
                const image = record.image !== false ? StringHelper.xss`<img class="profile-img" src="resources/images/${record.name.toLowerCase()}.jpg" alt="${record.name}"/>` : '';
                ...
                return StringHelper.xss`
                        ...
                        <div class="add" data-btip="Add client"><i class="b-fa b-fa-plus"></i></div>
                    ` + image;
            }
